...
func Handler(w http.ResponseWriter, r *http.Request) {
  ...
  "<p style=\"font-weight: bold;\"><center>Access path: <i>https://l.jkio.cf/platform/id</i></center></p>"+
  ...
  "<p style=\"font-weight: bold;\"><center>访问路径：<i>https://l.jkio.cf/platform/id</i></center></p>"+
